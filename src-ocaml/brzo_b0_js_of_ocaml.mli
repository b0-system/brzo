...
module Js_of_ocaml : sig
  ...
  val compile : ?args:Cmd.t -> Memo.t -> byte_exe:Fpath.t -> o:Fpath.t -> unit
  (** [compile m ~byte_exe ~o] compiles the byte code executable [byte_exe]
      to the JavaScript file [o]. *)


  val compile_toplevel :
    ?args:Cmd.t -> Memo.t -> byte_exe:Fpath.t -> mod_names:Fpath.t ->
    o:Fpath.t -> unit
  ...
  val link : ?args:Cmd.t -> Memo.t -> jss:Fpath.t list -> o:Fpath.t -> unit
